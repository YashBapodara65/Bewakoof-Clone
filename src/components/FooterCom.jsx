          ...
          <div className="b2 grid grid-cols-1 2xl:grid-cols-4">
            <div className="b2d1 mt-10">
              ...
              <p className="flex flex-wrap space-x-5 2xl:flex-col mt-8 space-y-1">
                ...
                <span className="text-gray-200">Men's Hoodies & Sweatshirts</span>
                <span className="text-gray-200">Oversized T-Shirts for Men</span>
                <span className="text-gray-200">Men's Long Sleeve T-Shirts</span>
                <span className="text-gray-200">Men's White T-Shirts</span>
                <span className="text-gray-200">Men's Crew Neck T-Shirts</span>
                <span className="text-gray-200">Men's Half Sleeve T-Shirts</span>
            ...
            <span className="text-gray-200">iPhone 15 Pro Max Back Covers</span>
            <span className="text-gray-200">iPhone 15 Pro Back Covers</span>
            <span className="text-gray-200">iPhone 15 Plus Back Covers</span>
            <span className="text-gray-200">iPhone 15 Back Covers</span>
            <span className="text-gray-200">iPhone 14 Pro Max Back Covers</span>
            <span className="text-gray-200">iPhone 14 Pro Back Covers</span>
            <span className="text-gray-200">iPhone 14 Plus Back Covers</span>
            <span className="text-gray-200">iPhone 14 Back Covers</span>
            <span className="text-gray-200">iPhone 13 Pro Max Back Covers</span>
            <span className="text-gray-200">iPhone 13 Pro Back Covers</span>
            <span className="text-gray-200">iPhone 13 Plus Back Covers</span>
